...
from auxiliary.statistics import mean, median, trimmed_mean, range, variance, standard_deviation
...
class SampleTestCase(ExtendedTestCase):
    ...
    def test_variances(self):
        self.assertSequenceAlmostEqual(list(map(range, self.values)), [0.25, 0.6, 0.13, 4])
